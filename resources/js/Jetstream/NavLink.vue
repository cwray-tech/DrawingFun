...
export default defineComponent({
    ...
    computed: {
        classes() {
            return this.active
                ? "inline-flex items-center px-1 pt-1 border-b-2 border-black text-sm font-medium leading-5 text-gray-900 focus:outline-none focus:border-black transition"
